(function () {
    ...
    (function () {
      ...
      var Zarget = (function () {
        ...
        (zarget.trackingOptOutAge = 10 * 365 * 24 * 60 * 60 * 1000),
          (zarget.eventBuffer = []);
        zarget.serverinfo = {
          serverurl: "https://app-ind.freshmarketer.com",
          secureServerURL: "https://app-ind.freshmarketer.com",
          ...
          cdnServerURL: "//toolbar.freshmarketer.in",
          previewToolbarURL: "https://toolbar.freshmarketer.in/preview-toolbar",
          loginurl: "/ab/api/auth/currentuser",
          pollUrl: "/ab/api/visitor/putinfo",
          tpUrl: "//tp.freshmarketer.in/getandset",
          ...
          sessionDataSendUrl: "https://src.freshmarketer.in/sr",
          eventDataSendUrl: "https://src.freshmarketer.in/mas",
          formTrackingUrl: "https://src.freshmarketer.in/mas",
          croDataSendUrl: "https://src.freshmarketer.in/cro",
          ...
          try {
            ...
            xhr.onreadystatechange = function () {
              if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                window.zarget_crossdomainrequestgoing = !1;
                if (callback) {
                  if (otherParams) {
        ...
        CssSelector = {
          ...
          cssPathStep: function (node, optimized, isTargetNode, excludes) {
            ...
            if (optimized) {
              if (id) {
                return new CssSelector.DOMNodePathStep(idSelector(id), !0);
              }
            ...
            if (!parent || parent.nodeType === Node.DOCUMENT_NODE) {
              return new CssSelector.DOMNodePathStep(nodeName, !0);
            }
            ...
            return new CssSelector.DOMNodePathStep(result, !1);
          },
        };
        CssSelector.DOMNodePathStep = function (value, optimized) {
          this.value = value;
          this.optimized = optimized || !1;
        };
        ...
        zarget.selector = function (node, excludes) {
          return node ? CssSelector.cssPath(node, !1, excludes) : "";
        };
        ...
        zarget.findExperiment = function (exps, Experiment) {
          ...
          for (var exp in visitorinfo) {
            ...
            if (
              ...
              matchVariationURL(expDet, null, !0)
            ) {
          ...
          if (e.type == EXPERIMENT.SPLIT) {
            for (i = 1, l = variations.length; i < l; i++) {
              ...
              if (e.regex && isSplitURLMatches(v.url)) {
                ...
                if (!e.regex && simple(v.url, !0)) {
                  exp = e;
                  break;
                }
              }
              if (matchVariationURL(e, null, !0)) {
                exp = e;
                break;
              }
            }
        ...
        zarget.isVisitorLocationInLocalStorage = function () {
          if (typeof localStorage !== "undefined") {
            return window.localStorage.zarget_visitor_location ? !0 : !1;
          }
          return !1;
        };
      ...
      (function (Zarget) {
        ...
        Targeting.prototype = {
          ...
          traffictype: function (c) {
            ...
            try {
              ...
              if (traffictype === TRAFFIC.SOCIAL) {
                return getSocialNetwork(referrer) ? !0 : !1;
              }
              if (traffictype === TRAFFIC.SEARCH) {
                return getSearchEngine(referrer) ? !0 : !1;
              }
              if (traffictype === TRAFFIC.MOBILE) {
                return new UserAgent().isMobile() ? !0 : !1;
              }
          ...
          bulkaudience: function (c) {
            ...
            try {
              if (c.condition === 1) {
                return window.bulkDetails[c.value.v.ID] ? !0 : !1;
              } else {
                if (c.condition === 2) {
                  return window.bulkDetails[c.value.v.ID] ? !1 : !0;
                }
              }
            } catch (e) {
              return !1;
          ...
          testConditionGroup: function (conditiongroup) {
            ...
            if (this.personalization) {
              ...
              return conditiontype === CONDITIONTYPE.AND && matches ? !0 : !1;
            }
          },
      ...
      var ZargetData = {
        ...
        polls: {},
        "domain-url": "rathnavijayaraju-60680703.freshmarketer.com",
        product_name: "Freshworks",
        webform_tracking_info: { enabled: !0 },
        BUNDLE_NAME: "sales360",
        samplePercentage: 75,
        "fwdomain-url": "rattanindiasupport.myfreshworks.com",
        audiences: {},
        integrations: {},
        goals: {},
        orgidhash: "42565050545050475A545E52444C5C5E5C5F5F58595D",
      };
      ...
      (function (Zarget, ZargetData) {
        ...
        Zarget.initPausedExperiment = function (orgid, expid, varid) {
          ...
          var apiurl = Zarget.serverinfo.getFullPath(
            ...
            experiment = {};
          experiment.id = expid;
          headers[Zarget.heatmapUiConfig.zarget_cors_header] = !0;
        ...
        Zarget.initHeatmap = function (experiment) {
          ...
          zgAddLoader();
          window._ab__toolbar__attached = !0;
      ...
      (function (Zarget, ZargetData) {
        ...
        (function () {
          ...
          function CustomEvent(event, params) {
            var d = document,
              defaultOpt = { bubbles: !1, cancelable: !1, detail: undefined },
              evt;
            if (!d || d.createEvent) {
              return;
            }
        ...
        if (ZargetData && ZargetData.project.jquery === 1) {
          window.zarget$ = jQuery.noConflict(!0);
        ...
        experiments.isTypeExps = function (type) {
          ...
          return abs.length === this.length ? !0 : !1;
        };
        ...
        experiments.filterGoal = function (evt) {
          ...
          for (var k = 0, expObj; k < len; k++) {
            ...
            appliedvariation = expObj.getAppliedVariation(!0);
        ...
        Experiment.prototype = {
          startExperiment: function () {
            ...
            if (experiment.type === 1) {
              ...
              if (experiment.isCrossDomainExperiment) {
                window.zarget_crossdomainrequestgoing = !0;
                Zarget.getVariationForExperimentAndUser(
                  experiment.id,
                  variation,
                  null,
              ...
              this.isRunning = !0;
              this.sendVisitorInfo(!1, userid ? !0 : !1);
              if (Zarget.mixpanel) {
                Zarget.mixpanel(this.getAppliedVariation(), experiment);
              }
              if (Zarget.kissmetrics) {
          ...
          getAppliedVariation: function (click) {
            try {
              ...
              if (
                ...
                if (variation) {
                  this.rememberVisitor(variation.id, !0);
                  this.sendVisitorInfo(!0);
                  return variation;
                }
              }
        ...
        function setExperimentsInCookie(masterCookie) {
          ...
          try {
            ...
            window.zarget_experiments_loaded = !0;
            Zarget.setCookie(
              Zarget.visitorInfoCookie,
              encodeURIComponent(Zarget.stringifyJSON(vobj)),
              age,
        ...
        function isGetExperimentsFinished() {
          if (window.zarget_experiments_loaded === undefined) {
            window.zarget_experiments_loaded = !1;
            Zarget.getVariationForExperimentAndUser(
              null,
              null,
                  ...
                  for (var b = 0; b < timeGoalExperiment[a].goals.length; b++) {
                    ...
                    if (count >= value) {
                      if (!timeGoalExperiment[a].goals[b].status) {
                        timeGoalExperiment[a].goals[b].status = !0;
                        trackTimeGoal(
        ...
        function setCookieForVariation(masterCookie, experiment) {
          ...
          window.zarget_isCrossDomainProcessOngoing = !1;
        }
        ...
        function getCookieFinished(experiment, callback, expObj) {
          if (window.zarget_isCrossDomainProcessOngoing === undefined) {
            ...
            window.zarget_isCrossDomainProcessOngoing = !0;
            return !1;
          } else {
          ...
          if (
            ...
            window.zarget$.each(bulkAudiences, function (idx1, bulkCondition) {
              ...
              if (val) {
                ...
                window.bulkDetails[bulkCondition.value.v.ID] = !1;
              }
            });
        ...
        if (window.zarget === undefined || window.zarget === !0) {
      ...
      (function (Zarget, ZargetData) {
        ...
        Zarget.on = function (c, evt, handler) {
          if (c.addEventListener) {
            c.addEventListener(evt, handler, !0);
          } else {
        ...
        Zarget.off = function (c, evt, handler) {
          if (c.removeEventListener) {
            c.removeEventListener(evt, handler, !0);
          } else {
        ...
        var ZargetScroll = {
          init: function () {
            ...
            ZargetScroll.isScrolling = !1;
            window.onscroll = function (e) {
              ZargetScroll.isScrolling = !0;
              window.setTimeout(function () {
                ZargetScroll.isScrolling = !1;
              }, 100);
            };
          ...
          for (var i = 0, exp; (exp = experiments[i]); i++) {
            ...
            if (exp.experiment.type === 3 && !isReturningUser) {
              ...
              if (traffic <= exp.experiment.traffic) {
                ...
                sendVisitorInfo(exp, !1, userid ? !0 : !1);
                runExperiment = !0;
              } else {
        ...
        Zarget.Funnel.prototype = {
          ...
          sendMessage: function (experiment, virtualpage) {
            ...
            var params = {
              ...
              r: r,
              ety: experiment.type,
              isflexi: experiment.isFlexiOrder ? !0 : !1,
            };
            if (virtualpage) {
      ...
      (function (Zarget, ZargetData) {
        ...
        function sendVisitorInfo(returning, status, geoData, rv) {
          ...
          poll.schedulertype && msg.addParam("sch", !0);
          Zarget.xhrService.send(msg);
        }
        ...
        Poll.dataBinding = {
          ...
          fnEnableSend: function (e) {
            ...
            if (!currentAnswerObj[index].engaged) {
              ...
              currentAnswerObj[index].started = !0;
              sendFieldData(typePrefix + currentAns.fid, null, "engaged", null);
              currentAnswerObj[index].engaged = !0;
            }
            var modelObj = Poll.dataBinding.model.questions;
          ...
          fnSendData: function () {
                  ...
                  var answered =
                    currentAnswerObj.value >= 0 && currentAnswerObj.value <= 6
                      ...
                      : currentAnswerObj.value >= 7 &&
                        ...
                        ? "neutral"
                        : "high";
                  var answeredObj = currentAns.answers.filter(
                    function (ansObj) {
            ...
            if (next === 1) {
              ...
              if (modelObj[ansIndex + 1]) {
                ...
                Zarget.updatePollData(poll.id, "completed", !0, poll.trigger);
                window
        ...
        function init() {
          ...
          if (ZargetData.project.excludeIps.length) {
            ...
            if (Zarget.matchesTargeting(excludeIpCheck, !1)) {
              return !1;
            }
          }
        ...
        function rememberPoll() {
          ...
          if (!vobj.hasOwnProperty(poll.id)) {
            if (poll.trigger) {
              var urlHash = Zarget.sdbmCode(document.URL);
              vobj[poll.id] = {};
              vobj[poll.id][urlHash] = { completed: !1 };
            } else {
              vobj[poll.id] = { completed: !1 };
            }
            Zarget.setStorage(
              Zarget.pollData,
              encodeURIComponent(Zarget.stringifyJSON(vobj)),
        ...
        function startExperiment() {
          ...
          Zarget.setUserID();
          rememberPoll();
          sendVisitorInfo(!1, "geo", userid ? !0 : !1);
          runPoll();
        }
        ...
        (function (a) {
          var EventStore = (function () {
            ...
            EventStore.prototype.pushCustomEvent = function (
              ...
              this.addEvent(new a.Event(event_name, event_data, !1));
            };
            ...
            EventStore.prototype.pagevisit = function () {
              ...
              this.addEvent(new a.Event(eventConst.PAGE_VISIT, {}, !0));
            };
        ...
        (function (a) {
          var EventHandler = (function () {
            ...
            EventHandler.prototype.bind = function () {
              var _this = this;
              this.listener.add(this.wnd, "load", !1, function (e) {
                _this.autoAssociateVisitor(e);
                _this.pagevisit(e);
              });
              this.listener.add(this.wnd, "beforeunload", !1, function () {
                _this.beforeunloadeve();
                return;
              });
              this.listener.add(this.wnd, "hashchange", !1, function (e) {
                _this.pagevisit(e);
              });
            };
            ...
            EventHandler.prototype.pagevisit = function (e) {
              ...
              this.eventStore.addEvent(
                new a.Event(eventConst.PAGE_VISIT, {}, !0),
              );
            };
      ...
      (function (Zarget, ZargetData) {
        try {
          ...
          function fmSourceTracking() {
            ...
            let notExp = old_date ? (Date.now() - old_date) / 60000 > 30 : !0;
            if (
              (sourceChange || notExp) &&
              ...
              if (FM && FM.trackMasEvent) {
                ...
                FM.trackMasEvent("source_tracking", !0, eventData);
              }
            }
          }
          ...
          function visitorSourceTracking() {
            ...
            if (
              ...
              if (FM && FM.trackMasEvent) {
                ...
                FM.trackMasEvent("VISITOR_SOURCE_TRACKING", !0, eventData);
              }
            }
          }
  ...
  (function (url, appToken, formCapture) {
    ...
    if (window.freshsales.salesData.length == 0) {
      ...
      freshsales.salesData.init(
        "https://rattanindiasupport.myfreshworks.com/crm/sales",
        "b886454ccffa953a59c92923e0621c735459e7b7c0cd7586261d53becf53269d",
        !0,
        31300762,
        "https://in.fw-cdn.com",
        { enabled: !0 },
    ...
    hallway: {
      ...
      getLabelForRadioOrCheckboxGroup: function (inputField) {
        ...
        radioButtonsGroup.each(function (index, radioButton) {
          var label = Freshsales.hallway.getLabel(radioButton, !0);
      ...
      getValue: function (inputField) {
        ...
        switch (inputType) {
          ...
          case "radio":
            ...
            value =
              Freshsales.hallway.getLabel(field, !0) || field.attr("value");
            break;
          case "checkbox":
            ...
            win.gloader_ready = function () {
              if ("google" in win) {
                if (win.google.loader.ClientLocation) {
                  ...
                  callback({ error: !0, source: "google" });
                }
                util.set_obj(
  ...
  function initFreshChat() {
    window.fcWidget.init({
      ...
      token: "88eb3f10-6aa5-4e47-9b4f-c33e4042fabb",
      host: "https://rathnavijayaraju-606807033794462627-86bd09cbdc26e5716910303.freshchat.com",
    });
  }
  function initialize(i, t) {
    ...
    i.getElementById(t)
      ...
      : (((e = i.createElement("script")).id = t),
        (e.async = !0),
        (e.src =
          "https://rathnavijayaraju-606807033794462627-86bd09cbdc26e5716910303.freshchat.com/js/widget.js"),
