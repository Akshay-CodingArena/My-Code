...
export default function PersistentSystemsBooking(props) {
  ...
  const [selectedCompany, setSelectedCompany] = useState(1207);
  ...
  const [selectedState, setSelectedState] = React.useState("5");
  const [selectedCity, setSelectedCity] = React.useState("35");
  const [selectedHub, setSelectedHub] = React.useState("204");
  ...
  useEffect(() => {
    if (file) {
      ...
      if (!fileCheck) {
        ...
        document.getElementById("uploadedFile").style.marginTop = "0px";
      } else {
  ...
  const submitHandler = async (e) => {
    ...
    if (!file) {
      ...
      document.getElementById("uploadedFile").style.display = "block";
      document.getElementById("uploadedFile").style.position = "absolute";
      document.getElementById("uploadedFile").style.top = "40px";
    }
                      ...
                      <div className="form-card">
                        <div className="rvModel-choose head-mobile">
                          <div className="bikeOfferBox">
                            ...
                            <h5>
                              {" "}
                              OFFER ON {model == "RV400"
                                ? model
                                : "RV400 BRZ"}{" "}
                            </h5>
                            {model == "RV400" ? (
                              <ul>
                                <li>Insurance free of cost (1+ 4 years)</li>
                                <li>
                                  50% discount on 2 year extended warranty
                                </li>
                                <li>Helmet free of cost</li>
                                {/* <span>*T&C Apply</span> */}
                              </ul>
                            ) : (
                              <ul>
...
"
                          ...
                          <div className="bike-box">
                            ...
                            <p>
                              85 KM/H{""}
                              <span data-title="Ideal Driving Conditions">
                                *
                              </span>
                            </p>
                            <h5>TOP SPEED</h5>
                  ...
                  <div className="desktop-color-pallet">
                    <div className="rvModel-choose desktop-choose-model">
                      ...
                      <div className="bikeOfferBox">
                        <h5>
                          {" "}
                          OFFER ON {model == "RV400" ? model : "RV400 BRZ"}{" "}
                        </h5>
                        {model == "RV400" ? (
                          <ul>
                            <li>Insurance free of cost (1+ 4 years)</li>
                            <li>50% discount on 2 year extended warranty</li>
                            <li>Helmet free of cost</li>
                            {/* <span>*T&C Apply</span> */}
                          </ul>
                        ) : (
