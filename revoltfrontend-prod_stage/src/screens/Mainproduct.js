...
function Mainproduct() {
  const [selectedBikeSecond, setSelectedBikeSecond] = useState("RV400BRZ");
  const [selectedBikeFirst, setSelectedBikeFirst] = useState("RV400");
  ...
  return (
    <>
      <MetaTags id="rv400">
        <title>
          RV400 by Revolt Motors: India's 1st AI-enabled Electric Motorcycle
        </title>
        <meta
          name="description"
...
"
      ...
      <div className="banner-slider">
        ...
        <div className="bit">
          ...
          >
            <img style={{ height: "auto" }} src="/images/mute.png" />
          </button>
        </div>
      </div>
