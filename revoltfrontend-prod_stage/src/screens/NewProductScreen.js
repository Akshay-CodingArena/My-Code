...
export default function ProductScreen(props) {
  ...
  if (proceedNext) {
    navigate(`/NewPlaceOrderScreen` + search, {
      state: {
        model: model,
        color: color,
      },
  ...
  console.log("Model is", location.state);
  ...
  useEffect(() => {
    ...
    if (!userInfo_info) {
      navigate(
        `/NewProductScreen/${window.location.pathname.split("/")[2]}` + search
      );
    }
                                  ...
                                  {product?.subscription?.map((item, i) => (
                                    <>
                                      ...
                                      >
                                        ...
                                        <div className="downPaymntDetails">
                                          <ul>
                                            <li>
                                              {model == "RV400"
                                                ? "₹0"
                                      ...
                                      <span>
                                        ...
                                        <div class="rvtooltip">
                                          ...
                                          <span class="tooltiptext">
                                            Get a full refund if you cancel your
