...
import { booking, bookingSave } from "../actions/userActions";
...
export default function BookingScreen(props) {
  ...
  useEffect(() => {
    if (window.location.href.split("?")?.[1]?.includes("model=RV400BRZ")) {
      setModel("RV400BRZ");
    } else if (window.location.href.split("?")?.[1]?.includes("model=RV400")) {
      setModel("RV400");
    }
    ...
    if (!data.status) {
      ...
      if (SlotAvilable?.city_stock == "ok") {
        ...
        if (error) {
          ...
          navigate(`/product-pricing/${color.model_id + utm}`, {
            state: {
              model,
              color,
            },
  ...
  return (
    <div>
      ...
      {/*  */}
      <section className="CashOverLay">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="CashOverLayBox">
                <h3>
                  Thank you for your interest! The special Eid offer has now
                  ended.
                </h3>
                <p>
                  You can still book your bike by{" "}
                  <Link to="/book">clicking here.</Link>
                </p>
              </div>
            </div>
          </div>
                      ...
                      <div className="rvModel-chooseBlock">
                        ...
                        {/* <div
                          ...
                          onClick={() => {
                            ...
                            setColor(
                              product?.RV400BRZ?.length
                                ? { ...product?.RV400BRZ?.[product?.RV400BRZ.length - 1] }
                                : {}
                            );
                            setFestiveOfferText(RV400BRZFestiveOffer);
                          }}
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            setColor(
                              product?.RV400?.length
                                ? { ...product?.RV400?.[product?.RV400.length - 1] }
                                : {}
                            );
                            setFestiveOfferText(RV400FestiveOffer);
                          }}
