...
export default function CallCenterScreen(props) {
  //
  ...
  const onSearchSubmit = () => {
    if (searchText != "" && searchSetType != "") {
      // console.log(searchSetType);
      dispatch(CallerbookingDetails(searchText, searchSetType, "booking"));
      // console.log(order);
  ...
  const onSearchBookSubmit = (booking_id) => {
    if (booking_id != "") {
      ...
      dispatch(CallerOrderDetails(booking_id, "booking", "booking"));
      // console.log(order);
      if (order?.status != false) {
        // setMessagetype("success");
      } else {
                                  ...
                                  <>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        {order?.order[0]?.refund_id ? (
                                          <b>
                                            {order?.order[0]?.refund_date} |{" "}
                                            {order?.order[0]?.refund_dateTime}{" "}
                                          </b>
                                        ) : (
                                          "NA"
                                        )}
