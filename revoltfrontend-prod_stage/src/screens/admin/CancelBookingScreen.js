...
export default function CancelBookingScreen(props) {
  ...
  const submitHandlercancel = (e) => {
    ...
    if (comment === "") {
      ...
      setConfmessage("");
      console.log(
        "Booking Cancel from cancelBookingSCreen",
        orders[0].order_id,
      );

      if (orders[0].razorpay_payment_id == "cash") {
        Cash_Orders_Cancelled(BookingId, reasontype, comment, "admin");
      } else {
        Orders_Cancelled(BookingId, reasontype, comment, "admin");
      }
      dispatch(detailsOrder(orders[0].order_id));
    }
    //dispatch(signin(BookingId));
  };
                                ...
                                <div className="col-12">
                                  ...
                                  <div className="req-data flex-dta">
                                    ...
                                    <p>
                                      ...
                                      <span>Booking - {item.createdAt}</span>
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            {item.order_status != "Cancel" && (
                              <>
                                ...
                                <div className="text-centers mx-autos mt-2">
                                  ...
                                  {/* :
                          <div className="cancel_biooking sl-btn" onClick={submitHandlercancel}>Cancel Booking</div>
                          } */}
                                </div>
                              </>
                            )}
                  ...
                  <div className="list-ch">
                    <ul className="mt-4 pl-0">
                      ...
                      <li>
                        ...
                        Insurance + Smart Card +  {orders[0]?.item_name == "RV400"
                                            ? ", 4G Connectivity"
                                            : ""}{" "} Charges + other
