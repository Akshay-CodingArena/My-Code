...
function RevoltBrz() {
  const [selectedBikeSecond, setSelectedBikeSecond] = useState("RV400");
  const [selectedBikeFirst, setSelectedBikeFirst] = useState("RV400BRZ");
...
"
      ...
      >
        <div className="container">
          ...
          <div className="row m-0 spec-border mb-3">
