  ...
  return (
    <>
      <MetaTags id="privacy">
        ...
        <link
          rel="canonical"
          href="https://www.revoltmotors.com/privacy-policy"
        />
      </MetaTags>
            ...
            <div className="col-12">
              <div className="simple-format">
                <div>
                  ...
                  <p>
                    This is the Privacy Policy for Revolt Motors, accessible
                    from https://www.revoltmotors.com
                  </p>
                  ...
                  <p>
                    ...
                    also guide how you can prevent these cookies from being
                    stored however this may downgrade or 'break' certain
                    elements of the sites functionality.
                  </p>
                  <p>
                    For more general information on cookies see the relatedweb
                    article on Cookies.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        ...
                        in various ways. For these to work, the social media
                        sites will set cookies through our site which may be
                  ...
                  <p>
                    In order to provide you better experience and better
                    function usability on site, you would require to provide
                    your basic details with us.Thesedetails will be
                    protected,but in some cases,may be shared with authorised
                    service providers for functions like storage and processing
                    payments. Please ensure that the details provided by youare
                    accurate and up to date.
                  </p>
                  <p>
                    Depending upon the activity you wish to carry out on the
                    Site, the information provided to Us shall be identified
                    either as mandatory or voluntary. An activity which requires
                    information to be mandatorily provided shall not be engaged
                    if You abstain from providing such information.
                  </p>
                  <p>
                    This includes the information that can be used to uniquely
                    identify or contact You. In order to avail the services
                    provided by Us, We may collect a variety of Personal
                    Information, including but not limited to, Your name, postal
                    address, phone number, email address, contact preferences,
                    etc. The term “Account” as referred to in this Privacy
                    Policy shall mean and include the Account held by the User
                    with Company (administered by a password) for using the
                    services as provided by Company.
                  </p>
                  <p>
                    The Personal Information is collected from You in a
                    voluntary fashion when You provide your credentials on the
                    Site managed by Us.
                  </p>
                  <p>
                  ...
                  <p>
                    Your Personal Information will be kept confidential, secured
                    and used to support Your relationship with Company and
                    further to clarify any discrepancies which may arise on Your
                    part on placing of an order or request, and other related
                    facilities provided by Company.
                  </p>
                  <p>
                    By using this Site and services provided on the Site, You
                    agree and You also acknowledge that with respect to certain
                    activities, the collection, transfer, storage and processing
                    of Your information may be undertaken by trusted third party
                    vendors or agents of Company such as credit card processors,
                    web hosting providers, communication services, and web
                    analytic providers etc.,, to help facilitate Us in providing
                    certain functions.
                  </p>
                  <p>
                    Non-Personal Information is any information that does not
                    reveal Your specific identity, such as, browser information,
                    information collected through Cookies (defined below), pixel
                    tags and other technologies, demographic information, etc.
                    As is true with most websites, Our Site gathers some
                    information automatically when You visit the URL of the Site
                    and stores it in log files. When You use the Site and the
                    services provided, We may collect certain information about
                    Your browser to facilitate, evaluate and verify Your use of
                    the Site, and the products and the services available on the
                    Site. This information is generally collected in aggregate
                    form, without identifying any user individually.
                  </p>

                  <h4>Information We Share</h4>
                  <p>
                    We will only disclose your personal information if required
                    by the authorities, or to protect and improve our Operations
                    or with certain affiliates who provide services like data
                    security, customer service and more.
                  </p>
                  <p>
                    Company may disclose any information provided by You on the
                    Site as may be deemed to be necessary or appropriate: (a)
                    under applicable law, including laws outside Your country of
                    residence; (b) to comply with legal process; (c) to respond
                    to requests from public and government authorities including
                    public and government authorities outside Your country of
                    residence; (d) to enforce Our Terms of Use; (e) to protect
                    Our operations or those of any of Our affiliates; (f) to
                    protect Our rights under law including but not limited to
                  ...
                  <p>
                    ...
                    identifiable information. Unless stated otherwise, Company’s
                    current privacy policy applies to all information that
                    Company has about Users and their account. Notwithstanding
                    the above, Company shall not be required to notify the Users
                    of any changes made to the privacy policy.{" "}
                  </p>

                  <h4>Disclaimer</h4>
                  <p>
                    Don’t accept the policy if you disagree with how we will use
                    your personal data.
                  </p>
                  <p>
                    Company shall not be liable for any loss or damage sustained
                    by reason of any disclosure, if at all required or occurred,
                    of any information concerning the user's account and/or
                    their verification process and particulars nor for any
                    error, omission, or inaccuracy with respect to any
                    information so disclosed and used whether or not in
                    pursuance of any legal process. The terms in this policy may
                    be changed / altered / modified by Company at any time.
                    Company is free to offer its services to any
                    client/prospective client without restriction.
                  </p>
                  <p>
                    By registering or by using this Site, you explicitly accept,
                    without limitation or qualification, the collection, use and
                    transfer of the Personal Information provided by you in the
