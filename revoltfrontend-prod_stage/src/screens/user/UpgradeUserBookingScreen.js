...
function UpgradeUserBookingScreen() {
  ...
  const getData = async () => {
    try {
      const { data } = await Axios.post(
        `${URL_API}/api/v1/customer/upgradeorderlist/${userInfo.id}`,
        {
                        ...
                        <div className="col-6">
                          <div className="req-data flex-dta">
                            ...
                            <p>
                              ...
                              <span>
                                {order.isPaid == 1 ? "Upgrade Booking" : "Date"}{" "}
                                <br /> {order.createdAt}
                              </span>
                            </p>
                          </div>
                                ...
                                <div className="row btn-width">
                                  {order.order_status == "Cancel" ? (
                                    ...
                                    <>
                                      {/* <div className='col-12'>
                  <div className="cancel_biooking_1">
                      <a className='sl-btn sb-btn' href={`/cancel-my-revolt/${order.booking_id}`}>Cancel Booking</a>
                  </div>
               </div> */}
                                      <div className="col-12">
                                        <div className="cancel_biooking_1">
                                          <a
                                            className="sl-btn"
                                            href={`/upgradebookingdetail/${order.order_id}`}
                                          >
                                            Booking Detail
                                          </a>
                                        </div>
                      ...
                      <div className="not-found">
                        <div className="not-found-message text-center">
                          <p>
                            ...
                            <br />
                            Please <Link to="/booking">click here</Link> to book
                            your Revolt bike!
                          </p>
                        </div>
                      </div>
...
export default UpgradeUserBookingScreen;
