...
export const userUpgradeReducer = (state = {}, action) => {
  switch (action.type) {
    case USER_UPGRADE_REQUEST:
      return { loading: true };
    case USER_UPGRADE_SUCCESS:
      return { loading: false, upgrade: action.payload };
    case USER_UPGRADE_FAIL:
      return { loading: false, error: action.payload };
    case USER_UPGRADE_RESET:
      return {};
    default:
      return state;
  }
...
export const userStateListReducer = (state = { loading: true }, action) => {
  switch (action.type) {
    case USER_STATE_LIST_REQUEST:
      return { loading: true };
    case USER_STATE_LIST_SUCCESS:
      return { loading: false, users: action.payload };
    case USER_STATE_LIST_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
